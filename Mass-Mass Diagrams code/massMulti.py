...
P=Find('PB',1)                                                        # days
Pdot=[Find('PBDOT',1),Find('PBDOT',3)]                          #unitless
wdot=[Find('OMDOT',1) ,Find('OMDOT',3)]                      # degrees/year
e=Find('ECC',1)                                           #unitless
gamma= [Find('GAMMA',1),Find('GAMMA',3)]                      #seconds 
x=Find('A1',1)                                               #light-seconds
s=[Find('SINI',1) ,Find('SINI',3)]                               #unitless
r=[Find('SHAPMAX',1) ,Find('SHAPMAX',3) ]                          #seconds*M_sun
